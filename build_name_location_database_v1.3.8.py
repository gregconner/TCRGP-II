#!/usr/bin/env python3
"""
Build Name and Location Database v1.3.8

ENHANCED v1.3.8 - Most Robust System:
...
class _FilteredStdout:
    ...
    """
    def __init__(self, underlying, detail_log):
        self._u = underlying
...
def populate_database(refresh: bool = False):
    ...
    try:
        sys.stdout = _FilteredStdout(orig_stdout, detail_log)
    except Exception:
        pass
