#!/usr/bin/env python3
"""
Download Comprehensive Tribal Place Names from Public Sources v1.1.9
...
def _builder_curated_disabled() -> bool:
    v = os.environ.get("TCRGP_DISABLE_BUILDER_CURATED", "").strip()
...
def download_comprehensive_tribal_place_list(mode: str = "fast", year: int = 2023) -> List[Dict]:
    ...
    if not _builder_curated_disabled():
