#!/usr/bin/env python3
"""
De-identify and Tag Transcripts for Research v1.8.0
...
RESEARCH_CATEGORIES = {
    "Membership": ["member", "membership", "members", "constituent", "constituents", "participant", "participants", "landowner", "landowners"],
    "Governance": ["board", "director", "directors", "leadership", "governance", "bylaw", "bylaws", "steering committee", "committee", "elected", "election"],
    "Finance": ["revenue", "revenues", "budget", "budgets", "financial", "grant", "grants", "funding", "loan", "loans", "credit", "dollar", "dollars", "$", "money", "fund", "funds", "investment", "investments"],
    "Employment": ["employee", "employees", "staff", "worker", "workers", "job", "jobs", "contractor", "contractors", "consultant", "consultants", "advisor", "advisors", "hire", "hiring", "workforce"],
    "Partnerships": ["partner", "partners", "partnership", "partnerships", "collaboration", "collaborations", "alliance", "alliances", "network", "networks", "support organization", "support organizations"],
    "Innovation": ["innovation", "innovations", "new practice", "new practices", "new model", "new models", "new product", "new products", "development", "developments", "pilot", "pilots"],
    "Operations": ["operation", "operations", "supply chain", "supply chains", "processing", "warehouse", "warehouses", "equipment", "production", "produce", "producing", "farm", "farming", "field", "fields"],
    "Markets": ["market", "markets", "sales", "customer", "customers", "revenue stream", "revenue streams", "distribution", "retail", "sell", "selling", "sold"],
    "Technology": ["digital", "website", "websites", "social media", "facebook", "online", "technology", "technologies", "software", "app", "apps", "internet", "email"],
    "Culture": ["traditional", "tradition", "traditions", "tribal value", "tribal values", "cultural", "culture", "indigenous", "heritage", "elder", "elders", "ceremony", "ceremonies", "custom", "customs"],
    "Geography": ["location", "locations", "reservation", "reservations", "tribal land", "tribal lands", "community", "communities", "region", "regions", "nation", "nations", "pueblo", "pueblos", "district", "districts"],
    "Risk": ["challenge", "challenges", "obstacle", "obstacles", "risk", "risks", "barrier", "barriers", "issue", "issues", "problem", "problems", "adaptation", "adaptations", "difficulty", "difficulties"],
    "Timeline": ["founded", "establish", "established", "year", "years", "since", "started", "start", "began", "begin", "created", "create", "formation", "formed", "incorporated", "incorporation"],
    "Success": ["success", "successful", "growth", "grow", "growing", "profit", "profits", "profitable", "sustainable", "sustainability", "impact", "impacts", "benefit", "benefits", "achievement", "achievements", "thrive", "thriving"],
    "COVID": ["covid", "covid-19", "pandemic", "coronavirus", "lockdown", "lockdowns", "quarantine", "quarantines", "remote work", "virtual", "zoom", "online meeting", "online meetings"]
}

# Survey questions alignment tags - EXPANDED v1.7.0 for better coverage
SURVEY_QUESTION_TAGS = {
    "Q1_TribalValues": ["tribal value", "tribal values", "traditional system", "traditional systems", "cultural", "culture", "indigenous value", "indigenous values", "heritage", "tradition", "traditions", "custom", "customs"],
    "Q2_MarketingPlan": ["marketing plan", "marketing plans", "business plan", "business plans", "marketing strategy", "marketing strategies", "sales plan", "sales plans", "strategy", "strategies"],
    "Q3_WebsiteSocial": ["website", "websites", "social media", "facebook", "instagram", "online", "digital marketing", "internet", "web", "social", "digital"],
    "Q4_OutsideAssistance": ["consultant", "consultants", "developer", "developers", "assistance", "help", "support organization", "support organizations", "partner", "partners", "collaboration", "collaborations", "external", "outside"],
    "Q5_StandardApproaches": ["cooperative model", "cooperative models", "coop development", "standard", "standards", "best practice", "best practices", "bylaw", "bylaws", "model", "models", "approach", "approaches"],
    "Q6_CommunityDifferences": ["challenge", "challenges", "difficult", "difficulty", "difficulties", "conflict", "conflicts", "issue", "issues", "problem", "problems", "disagree", "disagreement", "barrier", "barriers"],
    "Q7_LeadershipEngagement": ["tribal leader", "tribal leaders", "council", "councils", "chief", "chiefs", "board", "boards", "engage", "engagement", "communicate", "communication", "meeting", "meetings", "discuss", "discussion"],
    "Q8_Success": ["success", "successful", "grow", "growth", "growing", "profit", "profits", "profitable", "achieve", "achievement", "achievements", "accomplish", "accomplishment", "positive", "benefit", "benefits", "impact", "impacts", "thrive", "thriving"],
    "Q9_COVID": ["covid", "covid-19", "pandemic", "coronavirus", "lockdown", "lockdowns", "quarantine", "quarantines", "remote work", "virtual", "zoom", "online meeting", "online meetings"]
}
...
class DeIdentifier:
    ...
    def extract_entities_with_spacy(self, text: str) -> Dict[str, List[str]]:
        ...
        # Known false positives to exclude - IMPROVED v1.8.0
        ...
        for chunk in chunks:
            ...
            for ent in doc.ents:
                ...
                if ent.label_ == "PERSON":
                    ...
                    # Exclude if contains common non-name words - IMPROVED v1.7.0
                    if any(word in ent_lower for word in ["messenger", "bay", "harbor", "cheese", "instagram", "twitter", "youtube", "covid"]):
                        continue
    ...
    def extract_entities(self, text: str) -> Dict[str, List[str]]:
        ...
        # METHOD 1: Regex patterns for speaker labels (high precision) - IMPROVED v1.8.0
        person_patterns = [
            # Pattern: "FirstName LastName:" at start of line (speaker labels only)
            r'^([A-Z][a-z]+\s+[A-Z][a-z]+(?:\s+[A-Z][a-z]+)?)\s*:',
            # Pattern: Single capitalized name at start of line (common first names) - EXPANDED v1.8.0
            r'^(Pamela|Amy|Perry|Joy|Gabriel|Miranda|Danae|Vicki|Ricardo|Duran|Lea|Michelena|Anna|Jodi|Pam|Webster|Ariza|Sekiros|Richard|Dave|Sam|Chris|Barry|Roberto|Rufus|Valentino|Nelson|Rich|Diffin|Parks|Alatada|Richardson)\s*:',
        ]
        ...
        # METHOD 1.5: Extract last names mentioned alone (e.g., "Andrews said") - IMPROVED v1.8.0
        last_name_patterns = [
            r'\b(Andrews|Sattler|Burshia|Standing|Zeise|Ariza|Sekiros|Webster|Kimmerer|Ho-Chunk|Lesson|Umaha|Richardson|Diffin|Parks|Alatada)\s+(?:said|asked|told|mentioned|explained|stated|has|had|was|is|will|would|does|did|can|could)',
        ...
        # METHOD 1.6: Extract first names in dialogue (not just speaker labels) - IMPROVED v1.8.0
        # Common first names that appear alone in dialogue (case-insensitive matching)
        common_first_names_list = r'Gabriel|Miranda|Danae|Vicki|Joy|Pamela|Amy|Perry|Ricardo|Duran|Lea|Michelena|Anna|Jodi|Pam|Richard|Dave|Sam|Chris|Barry|Roberto|Rufus|Valentino|Nelson|Rich|Diffin|Parks|Alatada|Richardson'
...
def process_transcript(input_path: Path, output_dir: Path, use_spacy: bool = True, 
    ...
    # Extract timestamps from original text (for citation system) - IMPROVED v1.7.0
    ...
    if "WEBVTT" in text:
        ...
        if timestamp_line_pattern.search(text):
            print("    Detected non-WEBVTT timestamp format, parsing...")
            text, segments_with_timestamps = parse_non_webvtt_with_timestamps(text)
            if segments_with_timestamps:
...
Examples:
  ...
  python deidentify_and_tag_transcripts_v1.7.0.py --lines-per-page 40
    ...
    print("=" * 80)
    print("DE-IDENTIFY AND TAG TRANSCRIPTS v1.8.0")
    print("=" * 80)
