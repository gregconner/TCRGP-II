#!/usr/bin/env python3
"""
Build Name and Location Database v1.3.7

ENHANCED v1.3.7 - Most Robust System:
...
- Fix: progress ticker cannot be overridden—SIGALRM handlers are chained and ITIMER_REAL is kept active.
...
class OverallProgress:
    ...
    def begin(self):
        ...
        signal.signal(signal.SIGALRM, _our_handler)
