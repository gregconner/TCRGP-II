#!/usr/bin/env python3
"""
De-identify and Tag Transcripts for Research v1.17.2
...
Version: 1.17.2 (GPU support: CUDA + Metal/MPS)
"""
...
class KeywordTagger:
    ...
    def tag_text(self, text: str) -> Dict[str, List[Tuple[int, str, str]]]:
        ...
        tagged_count = len(tagged_lines)
        coverage = (tagged_count / total_lines * 100) if total_lines > 0 else 100
        # Coverage should now be 100% of non-empty lines, which guarantees 90%+ overall
...
Examples:
  ...
  python deidentify_and_tag_transcripts_v1.7.0.py --lines-per-page 40
    ...
    print("=" * 80)
    print("DE-IDENTIFY AND TAG TRANSCRIPTS v1.17.2")
    print("=" * 80)
