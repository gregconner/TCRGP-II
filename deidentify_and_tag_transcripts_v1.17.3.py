#!/usr/bin/env python3
"""
De-identify and Tag Transcripts for Research v1.17.3
...
Version: 1.17.3 (GPU support: CUDA + Metal/MPS)
"""
    ...
    if not speaker_letters:
        ...
        for raw in lines:
            ...
            if line_count > 0 and line_count % lines_per_page == 0:
                current_page += 1
                formatted_lines.append(f"\nPage {current_page}\n")
            formatted_lines.append(f"[{speaker_verse}] Narrative: {raw}")
            line_count += 1
...
def process_transcript(input_path: Path, output_dir: Path, use_spacy: bool = True, 
    ...
    # v1.17.3: Remove standalone timestamps early (they are not meaningful content and can be mis-graded as PII).
    # Keep this generic: applies to any transcript style with HH:MM:SS tokens.
...
Examples:
  ...
  python deidentify_and_tag_transcripts_v1.7.0.py --lines-per-page 40
    ...
    print("=" * 80)
    print("DE-IDENTIFY AND TAG TRANSCRIPTS v1.17.3")
    print("=" * 80)
