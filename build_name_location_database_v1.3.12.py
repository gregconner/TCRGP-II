#!/usr/bin/env python3
"""
Build Name and Location Database v1.3.12

ENHANCED v1.3.12 - Most Robust System:
    ...
    try:
        ...
        try:
            ...
            if download_script and download_script.exists():
                ...
                # Critical: prevent circular dependency if downloader tries to import the builder for curated lists.
                try:
